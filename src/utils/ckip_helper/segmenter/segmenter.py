...
class Segmenter:
    ...
    def __post_init__(self) -> None:
        self.ws_driver, self.pos_driver = connect_ckip_drivers()[:2]
    ...
    def segment(self) -> List[List[tuple]]:
        """The segment method segments the sentences in a list to word segmentation and part-of-speech results.
